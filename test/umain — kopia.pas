...
framecount:=raml^[$18000];
repeat
until raml^[$18000]>framecount;


//if skip=1 then songfreq*=2;
//box(18,864,512,128,244);
...
outtextxyz(32,1070,'Mousek: '+inttostr(peek($60033)),76,2,2);
outtextxyz(448,1070,'Mousex: '+inttostr(dpeek($6002c)),186,2,2);
outtextxyz(848,1070,timetostr(time),233,2,2);
...
//for j:=20 to 840 do box(20+j,700-scope[j] div 512,2,2,190);
//scj:=0;
{
